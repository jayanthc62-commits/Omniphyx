...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  // Show videos as returned by live search or category feed, only filtering if local search text entered
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between px-1">
          <h2 className="text-base sm:text-lg font-bold text-slate-100 flex items-center gap-2 tracking-tight">
            {isSearchActive ? `Results for "${searchFilter}"` : searchFilter ? `Filtered: "${searchFilter}"` : selectedCategory !== 'All' ? `${selectedCategory} Videos` : 'Trending & Recommended'}
