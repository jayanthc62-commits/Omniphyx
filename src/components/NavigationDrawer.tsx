...
import { 
  ...
  Clock, User, Smartphone, FolderUp, Download
} from 'lucide-react';
          ...
          <div className="space-y-1">
            ...
            {onOpenDownloadApk && (
              <button
                ...
                className="w-full flex items-center justify-between px-3.5 py-2.5 rounded-2xl font-medium text-xs tracking-wide bg-gradient-to-r from-emerald-500/15 to-transparent hover:from-emerald-500/25 border border-emerald-500/30 text-emerald-300 hover:text-white transition-all duration-200 active:scale-[0.98] shadow-sm mb-1"
              >
                <div className="flex items-center gap-3">
                  <Smartphone size={16} className="text-emerald-400" />
                  <span className="font-bold">Download APK</span>
                </div>
            ...
            {onOpenImportExport && (
              <button
                id="drawer-import-subs-btn"
                onClick={() => {
                  onOpenImportExport();
                  onClose();
                }}
                className="w-full flex items-center gap-3 px-3.5 py-2.5 rounded-2xl font-medium text-xs tracking-wide text-slate-300 hover:bg-white/[0.04] hover:text-white border border-transparent hover:border-white/[0.05] transition-all duration-200 active:scale-[0.98]"
              >
                <FolderUp size={16} className="text-red-400" />
